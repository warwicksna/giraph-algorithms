 ...
 */
public class LocalClusteringCoefficientVertex extends
    ...
    private static final Logger LOG =
        Logger.getLogger(LocalClusteringCoefficientVertex.class);
    /** The shortest paths id */
    public static String SOURCE_ID = "LocalClusteringCoefficientVertex.sourceId";
    ...
    /**
     * VertexInputFormat that supports {@link LocalClusteringCoefficientVertex}
     */
    public static class LocalClusteringCoefficientVertexInputFormat extends
    ...
    /**
     * VertexReader that supports {@link LocalClusteringCoefficientVertex}.  In this
     ...
     * [1,4.3,[[2,2.1],[3,0.7]]]
     */
    public static class LocalClusteringCoefficientVertexReader extends
            TextVertexReader<LongWritable,
                DoubleWritable, FloatWritable, DoubleWritable> {

        public LocalClusteringCoefficientVertexReader(
    ...
    /**
     * VertexOutputFormat that supports {@link LocalClusteringCoefficientVertex}
     */
    public static class LocalClusteringCoefficientVertexOutputFormat extends
        ...
        public VertexWriter<LongWritable, DoubleWritable, FloatWritable>
            ...
            return new LocalClusteringCoefficientVertexWriter(recordWriter);
        }
    }

    /**
     * VertexWriter that supports {@link LocalClusteringCoefficientVertex}
     */
    public static class LocalClusteringCoefficientVertexWriter extends
            TextVertexWriter<LongWritable, DoubleWritable, FloatWritable> {
        public LocalClusteringCoefficientVertexWriter(
    ...
    public int run(String[] argArray) throws Exception {
        ...
        job.setVertexInputFormatClass(
            LocalClusteringCoefficientVertexInputFormat.class);
        job.setVertexOutputFormatClass(
            LocalClusteringCoefficientVertexOutputFormat.class);
        FileInputFormat.addInputPath(job, new Path(argArray[0]));
        FileOutputFormat.setOutputPath(job, new Path(argArray[1]));
        job.getConfiguration().setLong(LocalClusteringCoefficientVertex.SOURCE_ID,
    ...
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new LocalClusteringCoefficientVertex(), args));
    }
}
