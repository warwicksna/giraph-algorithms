 ...
 */
public class NetworkLocalClusteringCoefficientVertex extends
    ...
    private static final Logger LOG =
        Logger.getLogger(NetworkLocalClusteringCoefficientVertex.class);
    /** The shortest paths id */
    public static String SOURCE_ID = "NetworkLocalClusteringCoefficientVertex.sourceId";
    ...
    public static class NetworkLocalClusteringCoefficientContext extends WorkerContext {
	...
	public void preApplication() throws InstantiationException, IllegalAccessException {
	    registerAggregator("sum", DoubleSumAggregator.class);
	}
	...
	public void preSuperstep() {
	    ...
	    if (getSuperstep() == 0) {
		sumAggreg.setAggregatedValue(new DoubleWritable(0L));
	    }
	}
    ...
    /**
     * VertexInputFormat that supports {@link NetworkLocalClusteringCoefficientVertex}
     */
    public static class NetworkLocalClusteringCoefficientVertexInputFormat extends
        ...
        public VertexReader<LongWritable, DoubleWritable, FloatWritable, DoubleWritable>
                createVertexReader(InputSplit split,
                                   ...
                                   throws IOException {
            return new NetworkLocalClusteringCoefficientVertexReader(
                textInputFormat.createRecordReader(split, context));
        }
    }

    /**
     * VertexReader that supports {@link NetworkLocalClusteringCoefficientVertex}.  In this
     ...
     * [1,4.3,[[2,2.1],[3,0.7]]]
     */
    public static class NetworkLocalClusteringCoefficientVertexReader extends
            TextVertexReader<LongWritable,
                DoubleWritable, FloatWritable, DoubleWritable> {

        public NetworkLocalClusteringCoefficientVertexReader(
    ...
    /**
     * VertexOutputFormat that supports {@link NetworkLocalClusteringCoefficientVertex}
     */
    public static class NetworkLocalClusteringCoefficientVertexOutputFormat extends
        ...
        public VertexWriter<LongWritable, DoubleWritable, FloatWritable>
            ...
            return new NetworkLocalClusteringCoefficientVertexWriter(recordWriter);
        }
    }

    /**
     * VertexWriter that supports {@link NetworkLocalClusteringCoefficientVertex}
     */
    public static class NetworkLocalClusteringCoefficientVertexWriter extends
            TextVertexWriter<LongWritable, DoubleWritable, FloatWritable> {
        public NetworkLocalClusteringCoefficientVertexWriter(
    ...
    public int run(String[] argArray) throws Exception {
        ...
        job.setVertexInputFormatClass(
            NetworkLocalClusteringCoefficientVertexInputFormat.class);
        job.setVertexOutputFormatClass(
            NetworkLocalClusteringCoefficientVertexOutputFormat.class);
	job.setWorkerContextClass(NetworkLocalClusteringCoefficientContext.class);
        FileInputFormat.addInputPath(job, new Path(argArray[0]));
        FileOutputFormat.setOutputPath(job, new Path(argArray[1]));
        job.getConfiguration().setLong(NetworkLocalClusteringCoefficientVertex.SOURCE_ID,
    ...
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new NetworkLocalClusteringCoefficientVertex(), args));
    }
}
