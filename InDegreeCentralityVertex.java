 ...
 */
public class InDegreeCentralityVertex extends
    ...
    private static final Logger LOG =
        Logger.getLogger(InDegreeCentralityVertex.class);
    /** The shortest paths id */
    public static String SOURCE_ID = "InDegreeCentralityVertex.sourceId";
    ...
    /**
     * VertexInputFormat that supports {@link InDegreeCentralityVertex}
     */
    public static class InDegreeCentralityVertexInputFormat extends
        ...
        public VertexReader<LongWritable, DoubleWritable, FloatWritable, DoubleWritable>
                createVertexReader(InputSplit split,
                                   ...
                                   throws IOException {
            return new InDegreeCentralityVertexReader(
                textInputFormat.createRecordReader(split, context));
        }
    }

    /**
     * VertexReader that supports {@link InDegreeCentralityVertex}.  In this
     ...
     * [1,4.3,[[2,2.1],[3,0.7]]]
     */
    public static class InDegreeCentralityVertexReader extends
            TextVertexReader<LongWritable,
                DoubleWritable, FloatWritable, DoubleWritable> {

        public InDegreeCentralityVertexReader(
    ...
    /**
     * VertexOutputFormat that supports {@link InDegreeCentralityVertex}
     */
    public static class InDegreeCentralityVertexOutputFormat extends
        ...
        public VertexWriter<LongWritable, DoubleWritable, FloatWritable>
            ...
            return new InDegreeCentralityVertexWriter(recordWriter);
        }
    }

    /**
     * VertexWriter that supports {@link InDegreeCentralityVertex}
     */
    public static class InDegreeCentralityVertexWriter extends
            TextVertexWriter<LongWritable, DoubleWritable, FloatWritable> {
        public InDegreeCentralityVertexWriter(
    ...
    public int run(String[] argArray) throws Exception {
        ...
        job.setVertexInputFormatClass(
            InDegreeCentralityVertexInputFormat.class);
        job.setVertexOutputFormatClass(
            InDegreeCentralityVertexOutputFormat.class);
        FileInputFormat.addInputPath(job, new Path(argArray[0]));
        FileOutputFormat.setOutputPath(job, new Path(argArray[1]));
        job.getConfiguration().setLong(InDegreeCentralityVertex.SOURCE_ID,
    ...
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new InDegreeCentralityVertex(), args));
    }
}
