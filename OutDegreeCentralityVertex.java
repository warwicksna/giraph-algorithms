 ...
 */
public class OutDegreeCentralityVertex extends
        EdgeListVertex<LongWritable, DoubleWritable,
        FloatWritable, LongWritable> implements Tool {
    /** Configuration */
    private Configuration conf;
    /** Class logger */
    private static final Logger LOG =
        Logger.getLogger(OutDegreeCentralityVertex.class);
    /** The shortest paths id */
    public static String SOURCE_ID = "OutDegreeCentralityVertex.sourceId";
    ...
    /**
     * VertexInputFormat that supports {@link OutDegreeCentralityVertex}
     */
    public static class OutDegreeCentralityVertexInputFormat extends
        ...
        public VertexReader<LongWritable, DoubleWritable, FloatWritable, DoubleWritable>
                createVertexReader(InputSplit split,
                                   ...
                                   throws IOException {
            return new OutDegreeCentralityVertexReader(
                textInputFormat.createRecordReader(split, context));
        }
    }

    /**
     * VertexReader that supports {@link OutDegreeCentralityVertex}.  In this
     ...
     * [1,4.3,[[2,2.1],[3,0.7]]]
     */
    public static class OutDegreeCentralityVertexReader extends
            TextVertexReader<LongWritable,
                DoubleWritable, FloatWritable, DoubleWritable> {

        public OutDegreeCentralityVertexReader(
    ...
    /**
     * VertexOutputFormat that supports {@link OutDegreeCentralityVertex}
     */
    public static class OutDegreeCentralityVertexOutputFormat extends
        ...
        public VertexWriter<LongWritable, DoubleWritable, FloatWritable>
            ...
            return new OutDegreeCentralityVertexWriter(recordWriter);
        }
    }

    /**
     * VertexWriter that supports {@link OutDegreeCentralityVertex}
     */
    public static class OutDegreeCentralityVertexWriter extends
            TextVertexWriter<LongWritable, DoubleWritable, FloatWritable> {
        public OutDegreeCentralityVertexWriter(
    ...
    public int run(String[] argArray) throws Exception {
        ...
        job.setVertexInputFormatClass(
            OutDegreeCentralityVertexInputFormat.class);
        job.setVertexOutputFormatClass(
            OutDegreeCentralityVertexOutputFormat.class);
        FileInputFormat.addInputPath(job, new Path(argArray[0]));
        FileOutputFormat.setOutputPath(job, new Path(argArray[1]));
        job.getConfiguration().setLong(OutDegreeCentralityVertex.SOURCE_ID,
    ...
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new OutDegreeCentralityVertex(), args));
    }
}
